...
from chatwithdb.domain.sql_generator.base import BaseSQLGeneratorService
from chatwithdb.domain.sql_generator.base import BaseSQLGeneratorServiceInput
from chatwithdb.domain.sql_generator.base import BaseSQLGeneratorServiceOutput
from chatwithdb.shared.models.state import ChatwithDBState
from chatwithdb.shared.models.state import SQLGeneratorState
from chatwithdb.shared.models.state import SubTask
from chatwithdb.shared.settings import SQLGeneratorSettings
        ...
        try:
            ...
            return {
                'sql_generator_state': SQLGeneratorState(
                    sql_query=sql_results.sql_query.replace('.createdAt', '."createdAt"'),
                ),
            }
        except Exception as e:
            logger.warning(
